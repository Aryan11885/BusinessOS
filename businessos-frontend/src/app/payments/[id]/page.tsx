        ...
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 sm:p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-slate-500 mt-2">Payment Details</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-10">
            <InfoCard title="Invoice ID" value={payment.invoice_id} />
            <InfoCard title="Amount" value={`₹${formatINR(payment.amount)}`} />
            <InfoCard title="Payment Method" value={payment.payment_method} />
            <InfoCard title="Transaction ID" value={payment.transaction_id || "-"} />
            <InfoCard title="Status" value={payment.status} />
            <InfoCard title="Payment Date" value={payment.payment_date || "-"} />
            <InfoCard
              title="Created"
